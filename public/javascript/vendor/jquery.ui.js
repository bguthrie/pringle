 ...
 (function(a) {
    ...
    a.widget("ui.button", {
        ...
        _create: function() {
            ...
            d && this.element.bind("change.button",
            function() {
                b.refresh()
            });
    ...
    c.widget("ui.dialog", {
        ...
        _create: function() {
            ...
            function() {
                ...
                a.close(i);
                return false
            }).appendTo(e); (a.uiDialogTitlebarCloseText = c("<span></span>")).addClass("ui-icon ui-icon-closethick").text(b.closeText).appendTo(h);
