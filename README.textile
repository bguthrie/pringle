...
* Pringle is a Javascript API for consuming the Mingle API using JSON/P.
* Pringle is a command-line console for consuming the Mingle API, similar to a database console.
...
Mingle has been tested using Google Chrome and Firefox 4 on Windows and Mac and Mingle 3.2 and nothing else. Although I like and appreciate the Opera guys, I'm not planning on supporting any other browsers at this time.

h2. 1. Use as a proxy server
...
h2. 2. Use for more complex visualizations
...
h2. 3. Use as a command-line console

I wrote a command-line console tool, similar to the a database client, because I got tired of the standard process for debugging my Mingle queries. Run it like so:
...
h2. 4. Use as a story wall (Pending)
